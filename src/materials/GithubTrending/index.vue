    ...
    <div class="github">
      ...
      <div v-else class="list">
        ...
        >
          ...
          <div v-if="item.todayStar" class="today-star">
            {{ item.todayStar }}
          </div>
          <div class="footer">
            <div v-if="item.language" class="language item">
              <div class="language-circle" :style="`background: ${item.color}`" />
              {{ item.language }}
            </div>
            <div v-if="item.totalStar" class="total-star item">
              <svg
                aria-label="star"
            ...
            <div v-if="item.forked" class="forked item">
              <svg
